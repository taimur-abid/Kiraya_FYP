  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{flexDirection:'column',alignItems:'center',flex:1}}>
        ...
        <Text style={{top:210,fontWeight:'700',fontSize:20,color:'#000000',textDecorationLine: 'underline'}}>Step 2</Text>
        
        <Text style={{top:220,fontWeight:'500',fontSize:15,color:'#000000',letterSpacing:0.06,textAlign:'center'}}> In order to rent on the app, we need to verify your mobile phone number. Enter your number and we’ll send you the 4-digit code.</Text>

        <View style={{flexDirection:'row',alignItems:'center',top:300}}>

            <Text style={{fontWeight:'bold',fontSize:14,color:'#000000',letterSpacing:0.06,textAlign:'center'}}>Phone Number :</Text>

            <TextInput 
            style={{color:'#5C83BC',fontSize:15,fontWeight:'bold',width:150}} 
            placeholder="i.e 03XXXXXXXXXX"
            keyboardType="numeric">
            </TextInput>

        </View>

        <TouchableOpacity style={styles.Bluebutton}  onPress={() => navigation.navigate('PhoneAuth')}>
