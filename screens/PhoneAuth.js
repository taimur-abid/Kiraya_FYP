  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{flexDirection:'column',alignItems:'center',flex:1}}>
        ...
        <Text style={{top:210,fontWeight:'700',fontSize:20,color:'#000000',textDecorationLine: 'underline'}}>Verify Phone OTP</Text>
        
        <Text style={{top:220,fontWeight:'500',fontSize:15,color:'#000000',letterSpacing:0.06,textAlign:'center'}}> In order to rent on the app, we need to verify your Phone Number

Enter your Phone-OTP. </Text>
