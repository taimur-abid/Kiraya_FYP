  ...
  return (
    <View style={styles.container}>
      <View style={styles.BlueView}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('Cart')}><Image style={styles.tinyLogo} source={require('./cart.png')} /></TouchableOpacity>
      </View>
      ...
      <ScrollView
        ...
        <ScrollView
          ...
          <Products product={DUMMY_PRODUCTS[0].product} navigation={props.navigation} price={DUMMY_PRODUCTS[0].price} image={DUMMY_PRODUCTS[0].image} city={DUMMY_PRODUCTS[0].city}/>
        ...
        <ScrollView
          ...
          <Products navigation={props.navigation} price={DUMMY_PRODUCTS[4].price} image={DUMMY_PRODUCTS[4].image} city={DUMMY_PRODUCTS[4].city}></Products>
          <Products navigation={props.navigation} price={DUMMY_PRODUCTS[5].price} image={DUMMY_PRODUCTS[5].image} city={DUMMY_PRODUCTS[5].city}></Products>
          <Products navigation={props.navigation} price={DUMMY_PRODUCTS[6].price} image={DUMMY_PRODUCTS[6].image} city={DUMMY_PRODUCTS[6].city}></Products>
          <Products navigation={props.navigation} price={DUMMY_PRODUCTS[7].price} image={DUMMY_PRODUCTS[7].image} city={DUMMY_PRODUCTS[7].city}></Products>
          <Products navigation={props.navigation} price={DUMMY_PRODUCTS[7].price} image={DUMMY_PRODUCTS[7].image} city={DUMMY_PRODUCTS[7].city}></Products>
          <Products navigation={props.navigation} price={DUMMY_PRODUCTS[7].price} image={DUMMY_PRODUCTS[7].image} city={DUMMY_PRODUCTS[7].city}></Products>
