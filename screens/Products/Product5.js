  ...
  return (
    <View style={styles.container} >
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={{flexGrow:1,flexDirection:'column'}}>
            ...
            <Image style={{width: 415,height: 286,top:1}} source={require('./speaker2.jpg')} /> 
            </View>

            <Text style={{fontSize:20,fontWeight:'bold',color:'#000000',left:20,top:2}}>Audionic Speaker</Text>
